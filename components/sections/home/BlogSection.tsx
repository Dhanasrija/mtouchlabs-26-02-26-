...
const blogs = [
  {
    href: "/turning-data-into-strategy",
    img: "/images/blogs/Generative AI Tools and Platforms1.png",
    imgAlt: "Turning Data into Strategy: The Power of Analytics",
    caption: ["Turning Data into Strategy: The", "Power of Analytics"],
  },
  {
    href: "/ai-streamline-business",
    img: "/images/blogs/ai-in-business.png",
    imgAlt: "5 Ways AI Can Streamline Business Operations",
    caption: ["5 Ways AI Can Streamline", "Business", "Operations"],
  },
  {
    href: "/human-machine-balance",
    img: "/images/blogs/artificial-intelligence-transforming-mobile-technology.png",
    imgAlt: "Human + Machine: Finding the Perfect Balance",
    caption: ["Human + Machine: Finding", "the", "Perfect Balance"],
  },
];
      ...
      <div className="blog-ref-container">
        ...
        <div className="blog-ref-header">
          <div className="blog-ref-header-left">
            <p className="blog-ref-label">&#8226; BLOG AND ARTICLES</p>
            <h2 className="blog-ref-title">
              <span className="blog-ref-title-accent">Latest</span> insights and trends
            </h2>
            <p className="blog-ref-desc">
              Whether you&apos;re optimizing today or building for tomorrow &nbsp;we help you move faster with confidence.
            </p>
          </div>
          <div className="blog-ref-header-right">
        ...
        <div className="blog-ref-cards">
          {blogs.map((blog, i) => (
            <div className="blog-ref-card" key={i}>
              <a href={blog.href}>
