...
//   title: "Contact Us | Software Consultation",
//   description: "Book an enterprise consultation with mTouch Labs to discuss SaaS, cloud, and AI solutions with expert architects across India and the USA.",
...
//                 <div className="cf-turnstile" data-sitekey={process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY} data-callback="onContactTurnstileSuccess" suppressHydrationWarning></div>
...
//       var d = Object.fromEntries(fd.entries());
//       d['cf-turnstile-response'] = contactTurnstileToken;
              ...
              <form id="contactForm" method="post" className="ct-form">
                <div className="ct-form__row">
                  <div className="ct-form__group">
                    <label className="ct-form__label">FULL NAME *</label>
                    <input type="text" name="name" className="ct-form__input" placeholder="John Doe" required />
                  </div>
                  <div className="ct-form__group">
                    <label className="ct-form__label">EMAIL *</label>
                    <input type="email" name="email" className="ct-form__input" placeholder="john@company.com" required />
                  </div>
                </div>
                <div className="ct-form__row">
                  <div className="ct-form__group">
                  ...
                  <div className="ct-form__group">
                    <label className="ct-form__label">PHONE *</label>
                    <div className="ct-form__phone-row">
                      <select name="countryCode" className="ct-form__select ct-form__country-code" defaultValue="91">
                      ...
                      <input type="tel" id="phoneInput" name="mobile" className="ct-form__input" placeholder="Mobile number" />
                    </div>
                    <span id="phoneHint" className="ct-form__hint"></span>
                  </div>
                </div>
                <div className="ct-form__row">
                  <div className="ct-form__group">
                ...
                <div className="ct-form__group ct-form__group--full">
                  ...
                  <textarea name="message" className="ct-form__textarea" placeholder="Tell us about your project..." rows={5} required maxLength={1000} />
                </div>
                <div className="cf-turnstile" data-sitekey={process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY} data-callback="onContactTurnstileSuccess" suppressHydrationWarning></div>
                <div className="ct-form__terms">
                  <input type="checkbox" id="terms" className="ct-form__checkbox" required />
                  <label htmlFor="terms" className="ct-form__checkbox-label">I agree to the <a href="/privacy-policy" className="ct-form__link">Privacy Policy</a> and consent to being contacted.</label>
                </div>
                <button type="submit" className="ct-form__submit">Send Message <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13" /><polygon points="22 2 15 22 11 13 2 9 22 2" /></svg></button>
                <div className="ct-form__secure"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" /></svg><span>100% Secure. Your information is encrypted and never shared with third parties.</span></div>
              </form>
...
(function() {
  ...
  function init() {
    ...
    f.addEventListener("submit", function(e) {
      ...
      // ── Ensure an error container exists (inserted once, reused) ──
      var errEl = f.querySelector(".ct-form__error");
      if (!errEl) {
        errEl = document.createElement("p");
        errEl.className = "ct-form__error";
      ...
      function resetBtn() {
        if (btn) { btn.disabled = false; btn.removeAttribute("aria-busy"); btn.innerHTML = originalBtnHtml; }
      }
