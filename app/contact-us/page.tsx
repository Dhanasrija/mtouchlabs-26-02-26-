...
const offices = [
  { hq: true, location: "India - Hyderabad Office", company: "mTouch Labs Private Limited", address: "#514, Manjeera Trinity Corporate, JNTU - Hitech City Road, Kukatpally, Hyderabad - 500072", landmark: "Landmark: Beside Manjeera Mall", mapUrl: "https://www.google.com/maps/place/mTouch+Labs+Pvt+Ltd+-+Software+Development+Company/@17.4892271,78.3901496" },
  { location: "India - Bangalore Office", company: "mTouch Labs Private Limited", address: "101, 4th Main Rd, Gayathri Layout, Vijaya Bank Layout, Bilekahalli, Bengaluru, Karnataka 560076", mapUrl: "https://www.google.com/maps/place/mTouch+Labs+Pvt+Ltd+-+Web+and+Mobile+App+Development+Company+%7C+Bangalore/@12.8905936,77.6054813" },
  { location: "USA - USA Office", company: "mTouch Labs", address: "1111b South Governors Avenue, Suite 48193, Dover, Delaware (DE)-19904, United States", mapUrl: "https://maps.app.goo.gl/amg7vRf4qFy6BFZW9" },
];
          ...
          function init() {
            ...
            form.addEventListener('submit', function(e) {
              ...
              fetch('https://93iji6x3i1.execute-api.ap-south-1.amazonaws.com/Dev/send-mail', {
                ...
                body: JSON.stringify({ title: 'Contact Form', type: 'contact', message: '\\nName: '+d.name+',\\nEmail: '+d.email+',\\nPhone: +'+d.countryCode+' '+d.mobile+',\\nInterested: '+d.interest+',\\nMessage: '+d.message })
