...
export default async function BlogPostPage({
  ...
  // ⭐ Use publish_date if available, fallback to created_at
  ...
  const articleJsonLd = {
    ...
    headline: blog.title,
    description: blog.meta_description || blog.description,
    image: blog.og_image || blog.image || '/images/Light.png',
    author: { '@type': 'Organization', name: authorName },
    publisher: {
      '@type': 'Organization',
      name: 'mTouch Labs',
  ...
  return (
    <div className="blv3-page">
      ...
      {/* ⭐ Client component for TOC highlighting — NO hydration error */}
      <TocScrollHighlight />
      ...
      {/* ⭐ REMOVED: No more inline <script> — TocScrollHighlight handles everything */}
    </div>
  );
}