...
export const metadata: Metadata = {
  ...
  description: "",
  alternates: {
    canonical: "https://www.mtouchlabs.com/app-and-web-development-for-ecommerce-services",
  },
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "name": "Ecommerce App & Web Development", "description": "Ecommerce App & Web Development", "url": "https://www.mtouchlabs.com/app-and-web-development-for-ecommerce-services", "provider": {"@type": "Organization", "name": "mTouch Labs", "url": "https://www.mtouchlabs.com", "logo": "https://www.mtouchlabs.com/images/mtouchlabs-logo.svg"}, "areaServed": {"@type": "Country", "name": "Worldwide"}, "serviceType": "Ecommerce App & Web Development"}),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.mtouchlabs.com"}, {"@type": "ListItem", "position": 2, "name": "Ecommerce App & Web Development", "item": "https://www.mtouchlabs.com/app-and-web-development-for-ecommerce-services"}]}),
        }}
      />
{/* page head */}
      <ServiceHero
