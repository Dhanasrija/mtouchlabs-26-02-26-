...
export const metadata: Metadata = {
  ...
  description: "mTouch Labs is a leading Software Development Company in India delivering custom software, enterprise applications, cloud services, and AI solutions.",
  keywords: ["software development company in India","custom software development India","enterprise software India"],
  openGraph: { images: [{ url: "/images/Light.png", width: 1200, height: 630, alt: "mTouch Labs" }],
    title: "Software Development Company in India",
    description: "mTouch Labs is a leading Software Development Company in India delivering custom software, enterprise applications, cloud services, and AI solutions.",
    url: "https://www.mtouchlabs.com/software-development-company-india",
    type: "website",
  },
  alternates: {
    canonical: "https://www.mtouchlabs.com/software-development-company-india",
    languages: {
  ...
  twitter: {
    ...
    site: "@mtouchlabs",
    creator: "@mtouchlabs",
    title: "Software Development Company in India | mTouch Labs",
    description: "mTouch Labs — software development company serving India with custom software, cloud, AI and enterprise applications.",
    images: [{ url: "/images/Light.png", alt: "mTouch Labs Software Development Company in India" }]
  },
...
const localBusinessSchema = {
  ...
  "name": "mTouch Labs — Software Development in India",
  "url": "https://www.mtouchlabs.com/software-development-company-india",
  "description": "mTouch Labs — custom software, enterprise apps, cloud and AI for clients in India.",
...
const locationBreadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Software Development Company in India", "item": "https://www.mtouchlabs.com/software-development-company-india" }
  ]
};

export default function SoftwareDevelopmentCompanyIndia() {
  return (
    <div className="loc-page">
        ...
        <div className="loc-heroInner">
          <div className="loc-heroContent">
            ...
            <h1 className="loc-heroTitle">
              ...
              <span className="loc-highlight">India</span>
            </h1>
            <p className="loc-heroDesc">
              Delivering scalable software solutions across India's leading tech cities from Bangalore to Mumbai.
            </p>
        ...
        <div className="loc-sectionInner">
          <div className="loc-sectionHeader">
            <h2 className="loc-sectionTitle">
              Our Services in <span className="loc-highlight">India</span>
            </h2>
      ...
      <section className="loc-section loc-industriesSection">
        <div className="loc-sectionInner">
          <div className="loc-sectionHeader">
            <h2 className="loc-sectionTitle">
              Industries We Serve in <span className="loc-highlight">India</span>
            </h2>
          </div>
          ...
          <div className="loc-faqList">
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Why choose a software development company in India?</span>
              ...
              <div className="loc-faqAnswer">India offers a strong technology ecosystem and access to skilled engineering talent, making it an ideal hub for software development.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Does mTouch Labs provide custom software development in India?</span>
                <span className="loc-faqChevron">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                </span>
              </summary>
              <div className="loc-faqAnswer">Yes, we provide fully customized software development services tailored to businesses in India.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Do you offer mobile app development in India?</span>
                <span className="loc-faqChevron">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                </span>
              </summary>
              <div className="loc-faqAnswer">Yes, we develop iOS, Android, and cross-platform mobile applications for businesses across India.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
              ...
              <div className="loc-faqAnswer">Yes, we offer cloud migration services and AI-powered automation solutions for India-based businesses.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
      ...
      <FAQSchema faqs={[
    { q: "Why choose a software development company in India?", a: "India offers a strong technology ecosystem and access to skilled engineering talent, making it an ideal hub for software development." },
    { q: "Does mTouch Labs provide custom software development in India?", a: "Yes, we provide fully customized software development services tailored to businesses in India." },
    { q: "Do you offer mobile app development in India?", a: "Yes, we develop iOS, Android, and cross-platform mobile applications for businesses across India." },
    { q: "Can you help with cloud migration and AI solutions?", a: "Yes, we offer cloud migration services and AI-powered automation solutions for India-based businesses." },
