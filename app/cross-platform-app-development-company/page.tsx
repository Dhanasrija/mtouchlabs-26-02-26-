...
const faqItems = [
  {
    ...
    a: "Cross platform app development allows businesses to build mobile applications for both iOS and Android using a single codebase, reducing cost and development time.",
  },
  {
    q: "Is cross platform development better than native?",
    a: "It depends on project requirements. Cross platform is cost-effective and faster to deploy, while native development may offer deeper hardware optimization for complex applications.",
  },
  {
    q: "Which frameworks does mTouch Labs use?",
    a: "We use Flutter, React Native, and modern hybrid technologies to deliver scalable mobile applications.",
  },
  {
    q: "How long does cross platform development take?",
    a: "Typical development time ranges from 6\u201316 weeks depending on features, integrations, and complexity.",
  },
];
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "name": "Cross Platform App Development Company", "description": "mTouch Labs is a cross platform app development company offering Flutter, React Native, and hybrid mobile solutions for scalable growth.", "url": "https://www.mtouchlabs.com/cross-platform-app-development-company", "provider": {"@type": "Organization", "name": "mTouch Labs", "url": "https://www.mtouchlabs.com", "logo": "https://www.mtouchlabs.com/images/mtouchlabs-logo.svg"}, "areaServed": {"@type": "Country", "name": "Worldwide"}, "serviceType": "Cross Platform App Development Company"}),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.mtouchlabs.com"}, {"@type": "ListItem", "position": 2, "name": "Cross Platform App Development Company", "item": "https://www.mtouchlabs.com/cross-platform-app-development-company"}]}),
        }}
      />
      <script
        type="application/ld+json"
      ...
      <section className="xp-sec">
        <div className="xp-w">
          <div className="xp-grid2">
            <div>
              <span className="xp-tag">Overview</span>
              <h2 className="xp-h2">
                What is <span className="xp-gold">Cross Platform</span> App
                Development?
              </h2>
              <p className="xp-p">
                Cross platform app development is the process of building mobile
                applications that function across multiple operating systems —
                primarily iOS and Android — using a shared codebase.
              </p>
              <p className="xp-p">
                Instead of developing separate native apps, businesses can
                reduce development cost, maintain a single code repository,
                ensure faster updates, deliver consistent user experience, and
                scale efficiently across platforms.
              </p>
              <p className="xp-p">
                We help startups, SMEs, and enterprises reduce development time,
                optimize costs, and accelerate time-to-market through modern
                cross-platform technologies such as Flutter, React Native, and
                progressive frameworks.
              </p>
            </div>
            <div className="xp-stats2">
              <div className="xp-kpi-card">
                <strong>2</strong>
                <span>Platforms, One Build</span>
              </div>
              <div className="xp-kpi-card">
                <strong>14+</strong>
      ...
      {/* SERVICES */}
      <section className="xp-sec xp-sec--gray">
        <div className="xp-w">
          <span className="xp-tag xp-tag--c">What We Offer</span>
          <h2 className="xp-h2 xp-h2--c">
            Our Cross Platform{" "}
            <span className="xp-gold">Development Expertise</span>
          </h2>
          <div className="xp-cards2">
            {[
              {
                n: "01",
                t: "Flutter App Development",
                d: "Build high-performance, natively compiled applications from a single Dart codebase using Google\u2019s Flutter framework.",
                li: [
              ...
              {
                n: "02",
                t: "React Native Development",
                d: "JavaScript-powered mobile apps with reusable components and enterprise-grade scalability.",
                li: [
                  "Reusable components",
              ...
              {
                n: "03",
                t: "Hybrid App Development",
                d: "Web + Mobile compatibility optimized for multi-device performance across all platforms.",
                li: [
              ...
              {
                n: "04",
                t: "UI/UX Design for Cross-Platform",
                d: "Platform-adaptive designs that respect iOS and Android design guidelines while maintaining brand consistency.",
                li: [
                  "Material Design & Cupertino patterns",
              ...
              {
                n: "05",
                t: "API & Backend Integration",
                d: "Seamless connection to your existing systems, third-party APIs, and cloud services.",
                li: [
              ...
              {
                n: "06",
                t: "Migration & Modernization",
                d: "Migrate your existing native apps to a unified cross-platform codebase without losing functionality.",
                li: [
                  "Native to Flutter/React Native migration",
              ...
              <div key={s.n} className="xp-card">
                <span className="xp-card__num">{s.n}</span>
                <h3 className="xp-card__t">{s.t}</h3>
                <p className="xp-card__d">{s.d}</p>
                <ul className="xp-card__ul">
                  {s.li.map((l, j) => (
                    <li key={j}>{l}</li>
                  ))}
                </ul>
      ...
      <section className="xp-sec">
        <div className="xp-w">
          <span className="xp-tag xp-tag--c">Tech Stack</span>
          <h2 className="xp-h2 xp-h2--c">
            Our <span className="xp-gold">Technology Stack</span>
          </h2>
          <p className="xp-sub">
            We work with industry-leading cross-platform frameworks to ensure
            your app delivers native-quality performance, smooth animations, and
      ...
      {/* PROCESS */}
      <section className="xp-sec xp-sec--dark">
        <div className="xp-w">
          <span className="xp-tag xp-tag--c xp-tag--dk">How We Work</span>
          <h2 className="xp-h2 xp-h2--c xp-h2--w">
            Our <span className="xp-glow">Development Process</span>
          </h2>
          <p className="xp-sub xp-sub--w">
            We follow a structured and agile approach that ensures high
          ...
          <div className="xp-steps">
            {[
              ...
              <div key={i} className="xp-step">
                <span className="xp-step__n">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <span className="xp-step__t">{s}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="xp-sec">
        <div className="xp-w">
          <span className="xp-tag xp-tag--c">Benefits</span>
          <h2 className="xp-h2 xp-h2--c">
            Why Choose <span className="xp-gold">Cross Platform</span>{" "}
            Development?
          </h2>
          <div className="xp-bens">
            {[
              {
                i: "fa-solid fa-dollar-sign",
                t: "Lower development & maintenance cost",
              },
              { i: "fa-solid fa-rocket", t: "Faster time-to-market" },
              { i: "fa-solid fa-palette", t: "Unified brand experience" },
              { i: "fa-solid fa-arrows-rotate", t: "Simplified updates" },
              { i: "fa-solid fa-globe", t: "Wider audience reach" },
              {
                i: "fa-solid fa-bolt",
                t: "Quick MVP for startups, scalable growth for enterprises",
              },
            ].map((b, i) => (
              <div key={i} className="xp-ben">
                <div className="xp-ben__ic">
                  <i className={b.i} />
                </div>
                <span>{b.t}</span>
              </div>
      ...
      <section className="xp-sec xp-sec--gray">
        <div className="xp-w">
          <div className="xp-grid2">
            <div>
              <span className="xp-tag">Our Edge</span>
              <h2 className="xp-h2">
                Why Choose <span className="xp-gold">mTouch Labs</span>?
              </h2>
              <p className="xp-p">
                As a forward-thinking Digital Transformation Company, we combine
                mobile engineering expertise with strategic consulting. We focus
                not only on app development but on delivering measurable
                business impact.
              </p>
              <ul className="xp-checklist">
                <li>
                  <i className="fa-solid fa-check" /> Modern frameworks
                  (Flutter, React Native)
                </li>
                <li>
                  <i className="fa-solid fa-check" /> Cloud-integrated mobile
                  backend systems
                </li>
                <li>
                  <i className="fa-solid fa-check" /> API &amp; third-party
                  integrations
                </li>
                <li>
                  <i className="fa-solid fa-check" /> Secure architecture
                  standards
                </li>
                <li>
                  <i className="fa-solid fa-check" /> Performance optimization
                </li>
                <li>
                  <i className="fa-solid fa-check" /> Long-term technical
                  support
                </li>
              </ul>
            </div>
            <div className="xp-trust">
              <h3>Trusted by 200+ Clients</h3>
              <p>
                From startups launching MVPs to enterprises scaling digital
                operations — we deliver results.
              </p>
              <a href="/contact-us" className="xp-btn xp-btn--gold">
      ...
      <section className="xp-sec">
        <div className="xp-w">
          <span className="xp-tag xp-tag--c">Domains</span>
          <h2 className="xp-h2 xp-h2--c">
            Industries <span className="xp-gold">We Build For</span>
          </h2>
          <div className="xp-indus">
            {[
              { i: "fa-solid fa-cart-shopping", n: "eCommerce & Retail" },
              { i: "fa-solid fa-heart-pulse", n: "Healthcare & HealthTech" },
              { i: "fa-solid fa-landmark", n: "FinTech & Banking" },
              { i: "fa-solid fa-graduation-cap", n: "EdTech Platforms" },
              { i: "fa-solid fa-building", n: "Real Estate & PropTech" },
              { i: "fa-solid fa-rocket", n: "SaaS & Startups" },
            ].map((ind, i) => (
              <div key={i} className="xp-ind">
                <i className={ind.i} />
                <span>{ind.n}</span>
              </div>
            ))}
      ...
      <section className="xp-sec xp-sec--gray">
        <div className="xp-w">
          <span className="xp-tag xp-tag--c">Got Questions?</span>
          <h2 className="xp-h2 xp-h2--c">
            Frequently Asked <span className="xp-gold">Questions</span>
          </h2>
          <div className="xp-faqs">
            {faqItems.map((f, i) => (
              <details key={i} className="xp-faq">
                <summary>
                  <span>{f.q}</span>
                  <span className="xp-faq__plus" />
                </summary>
                <p>{f.a}</p>
              </details>
            ))}
      ...
      <section className="xp-cta">
        <div className="xp-w xp-cta__body">
          <h2>
            Ready to Build Your{" "}
            <span className="xp-glow">Cross-Platform</span> App?
          </h2>
          <p>
            Let&apos;s discuss your project requirements and find the perfect
            cross-platform solution for your business.
          </p>
          <a href="/contact-us" className="xp-btn xp-btn--wh">
