...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.mtouchlabs.com/software-development-company-united-arab-emirates",
    languages: {
  ...
  twitter: {
    ...
    site: "@mtouchlabs",
    creator: "@mtouchlabs",
    title: "Software Development Company in UAE | mTouch Labs",
    description: "mTouch Labs — software development company serving UAE with custom software, cloud, AI and enterprise applications.",
    images: [{ url: "/images/Light.png", alt: "mTouch Labs Software Development Company in UAE" }]
  },
...
const localBusinessSchema = {
  ...
  "name": "mTouch Labs — Software Development in UAE",
  "url": "https://www.mtouchlabs.com/software-development-company-united-arab-emirates",
  "description": "mTouch Labs — custom software, enterprise apps, cloud and AI for clients in UAE.",
  "image": "https://www.mtouchlabs.com/images/Light.png",
  "priceRange": "$$",
  "areaServed": { "@type": "Country", "name": "UAE" },
  "address": { "@type": "PostalAddress", "addressLocality": "UAE", "addressCountry": "AE" },
...
const locationBreadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Software Development Company in UAE", "item": "https://www.mtouchlabs.com/software-development-company-united-arab-emirates" }
  ]
};

export default function SoftwareDevelopmentCompanyUnitedarabemirates() {
  return (
    <div className="loc-page">
        ...
        <div className="loc-heroInner">
          <div className="loc-heroContent">
            <div className="loc-heroBadge">
              ...
              mTouch Labs · United Arab Emirates
            </div>
            <h1 className="loc-heroTitle">
              Software Development Company in{" "}
              <span className="loc-highlight">United Arab Emirates</span>
            </h1>
            <p className="loc-heroDesc">
              Scalable digital solutions for businesses across the UAE including Dubai and Abu Dhabi.
            </p>
        ...
        <div className="loc-sectionInner">
          <div className="loc-sectionHeader">
            <h2 className="loc-sectionTitle">
              Our Services in <span className="loc-highlight">United Arab Emirates</span>
            </h2>
            <p className="loc-sectionDesc">
              End-to-end software development services tailored for United Arab Emirates businesses.
            </p>
          </div>
      ...
      <section className="loc-section loc-industriesSection">
        <div className="loc-sectionInner">
          <div className="loc-sectionHeader">
            <h2 className="loc-sectionTitle">
              Industries We Serve in <span className="loc-highlight">United Arab Emirates</span>
            </h2>
          </div>
          ...
          <div className="loc-faqList">
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Why choose a software development company in United Arab Emirates?</span>
              ...
              <div className="loc-faqAnswer">United Arab Emirates offers a strong technology ecosystem and access to skilled engineering talent, making it an ideal hub for software development.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Does mTouch Labs provide custom software development in United Arab Emirates?</span>
                <span className="loc-faqChevron">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                </span>
              </summary>
              <div className="loc-faqAnswer">Yes, we provide fully customized software development services tailored to businesses in United Arab Emirates.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Do you offer mobile app development in United Arab Emirates?</span>
                <span className="loc-faqChevron">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                </span>
              </summary>
              <div className="loc-faqAnswer">Yes, we develop iOS, Android, and cross-platform mobile applications for businesses across United Arab Emirates.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
              ...
              <div className="loc-faqAnswer">Yes, we offer cloud migration services and AI-powered automation solutions for United Arab Emirates-based businesses.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
      ...
      <FAQSchema faqs={[
    { q: "Why choose a software development company in United Arab Emirates?", a: "United Arab Emirates offers a strong technology ecosystem and access to skilled engineering talent, making it an ideal hub for software development." },
    { q: "Does mTouch Labs provide custom software development in United Arab Emirates?", a: "Yes, we provide fully customized software development services tailored to businesses in United Arab Emirates." },
    { q: "Do you offer mobile app development in United Arab Emirates?", a: "Yes, we develop iOS, Android, and cross-platform mobile applications for businesses across United Arab Emirates." },
    { q: "Can you help with cloud migration and AI solutions?", a: "Yes, we offer cloud migration services and AI-powered automation solutions for United Arab Emirates-based businesses." },
