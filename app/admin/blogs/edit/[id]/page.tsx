...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.mtouchlabs.com/admin/blogs/edit/[id]",
        ...
        <div className="body">
          ...
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:24}}>
            ...
            <div style={{display:'flex',gap:10,alignItems:'center',flexShrink:0}}>
              <a href={`/blog/${blog.slug}`} target="_blank" rel="noopener noreferrer" style={{padding:'10px 22px',borderRadius:8,fontSize:14,fontWeight:600,fontFamily:"'Inter',sans-serif",background:'#fff',color:'#374151',border:'1px solid #d1d5db',textDecoration:'none'}}>Preview</a>
