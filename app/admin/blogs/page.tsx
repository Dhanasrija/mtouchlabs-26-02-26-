...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "All Blogs | Admin",
    description: "All Blogs | Admin",
    url: "https://www.mtouchlabs.com/admin/blogs",
    siteName: "mTouch Labs",
    type: "website",
    images: [{ url: "https://www.mtouchlabs.com/images/web-and-mobile-app-development.webp", width: 1200, height: 630, alt: "All Blogs | Admin" }],
  },
  twitter: {
                    ...
                    <td style={{position:'relative'}}>
                      <details className="ab-menu">
                        ...
                        <div className="ab-dropdown">
                          ...
                          <a href={`/blog/${blog.slug}`} target="_blank" rel="noopener noreferrer" className="ab-dd-item">
