  ...
  return (
      ...
      <div className="grocery-delivery-one">
               ...
               <div className="grocery-delivery-features-box2">
                  <div>
                     <div className="grocery-box2-content">
                        <div><img src="/images/products/grocery/grocery1.png" alt="Scheduled Delivery"
                              className="grocery1-icons" loading="lazy" /></div>
                        <p>Scheduled <br /> Delivery</p>
                     </div>
                     <div className="grocery-box2-content2">
                        <div><img src="/images/products/grocery/grocery2.png" alt="Product Search and Filters"
                              className="grocery1-icons" loading="lazy" /></div>
                  ...
                  <div>
                     <div className="grocery-box2-content2">
                        <div><img src="/images/products/grocery/grocery3.png" alt="Real-Time Order Tracking"
                              className="grocery1-icons" loading="lazy" /></div>
                        <p>Real-Time <br />Order Tracking</p>
                     </div>
                     <div className="grocery-box2-content">
                        <div><img src="/images/products/grocery/grocery4.png" alt="Order Customization"
                              className="grocery1-icons" loading="lazy" /></div>
         ...
         <div className="grocery-delivery-mobile-container">
            ...
            <div className="grocery-delivery-mobile-text-section">
               ...
               <p>
                  ...
                  provide a practical way for time-pressed people to save money without
         ...
         <div className="grocery-delivery-two">
            <div className="grocery-delivery-mobile-container">
               ...
               <div className="grocery-delivery-mobile-phone-section">
                  <img src="/images/products/grocery/appfully.png" alt="Customizable Grocery App"
                     className="grocery-delivery-mobile-phone-image" loading="lazy" />
               </div>
         ...
         <div className="grocery-delivery-mobile-container">
            <div className="grocery-delivery-mobile-text-section">
               <h3>Online Grocery Delivery Applications</h3>
               <p>Welcome to mTouch Labs, your trusted partner for{" "}
                  <Link href="/flutter-app-development-company" style={{ color: "#3e8cfb", fontWeight: 600 }}>
                     grocery delivery app development
                  </Link>. In today&#39;s
                  fast-paced world, having a reliable and user-friendly app is essential for grocery businesses
                  looking to stay competitive. We specialize in creating{" "}
                  <Link href="/custom-software-development-company" style={{ color: "#3e8cfb", fontWeight: 600 }}>
                     custom grocery delivery apps
                  </Link>{" "}
                  that cater to your specific needs and requirements.</p>
               <p>From{" "}
                  <Link href="/ui-ux-design-company" style={{ color: "#3e8cfb", fontWeight: 600 }}>
                     user-friendly interfaces
                  </Link>{" "}
                  to seamless payment integration, we ensure that your app provides a
            ...
            <div className="container">
               ...
               <div className="app-screenss owl-carousel mt70 dottss">
                  <div className="appscreen">
                     <div className="itme-img"><img src="/images/products/grocery/appscreen1.png" alt="Grocery app screen 1"
                           className="img-fluid" /></div>
                  </div>
                  <div className="appscreen">
                     <div className="itme-img"><img src="/images/products/grocery/appscreen2.png" alt="Grocery app screen 2"
                           className="img-fluid" /></div>
                  </div>
                  <div className="appscreen">
                     <div className="itme-img"><img src="/images/products/grocery/appscreen3.png" alt="Grocery app screen 3"
                           className="img-fluid" /></div>
                  </div>
                  <div className="appscreen">
                     <div className="itme-img"><img src="/images/products/grocery/appscreen4.png" alt="Grocery app screen 4"
                           className="img-fluid" /></div>
                  </div>
                  <div className="appscreen">
                     <div className="itme-img"><img src="/images/products/grocery/appscreen5.png" alt="Grocery app screen 5"
                           className="img-fluid" /></div>
                  </div>
               </div>
		</div>
   ...
   <div className="food-cta-section">
      <div className="food-cta-content">
         ...
         <p>Drive your business forward with our customizable Grocery Delivery App Development Solutions</p>
         <Link href="/contact-us" className="food-cta-button">Let&#39;s Bring Your Idea to Life<i
               className='fas fa-arrow-right' id="food-button-icon"></i></Link>
      </div>
