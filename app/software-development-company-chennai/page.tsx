...
export const metadata: Metadata = {
  ...
  description: "mTouch Labs is a leading Software Development Company in Chennai delivering custom software, enterprise applications, cloud services, and AI solutions.",
  keywords: ["software development company in Chennai","custom software development Chennai","enterprise software Chennai"],
  ...
  alternates: {
    canonical: "https://www.mtouchlabs.com/software-development-company-chennai",
    languages: {
  ...
  twitter: {
    ...
    site: "@mtouchlabs",
    creator: "@mtouchlabs",
    title: "Software Development Company in Chennai | mTouch Labs",
    description: "mTouch Labs — software development company serving Chennai with custom software, cloud, AI and enterprise applications.",
    images: [{ url: "/images/Light.png", alt: "mTouch Labs Software Development Company in Chennai" }]
  },
...
const localBusinessSchema = {
  ...
  "name": "mTouch Labs — Software Development in Chennai",
  "url": "https://www.mtouchlabs.com/software-development-company-chennai",
  "description": "mTouch Labs — custom software, enterprise apps, cloud and AI for clients in Chennai.",
  "image": "https://www.mtouchlabs.com/images/Light.png",
  "priceRange": "$$",
  "areaServed": { "@type": "Country", "name": "Chennai" },
...
const locationBreadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Software Development Company in Chennai", "item": "https://www.mtouchlabs.com/software-development-company-chennai" }
  ]
};
    ...
    <div className="loc-page">
        ...
        <div className="loc-heroInner">
          <div className="loc-heroContent">
            ...
            <h1 className="loc-heroTitle">
              ...
              <span className="loc-highlight">Chennai</span>
            </h1>
            <p className="loc-heroDesc">
              Accelerating digital transformation for Chennai's enterprise and industrial ecosystem with scalable solutions.
            </p>
        ...
        <div className="loc-sectionInner">
          <div className="loc-sectionHeader">
            <h2 className="loc-sectionTitle">
              Our Services in <span className="loc-highlight">Chennai</span>
            </h2>
            <p className="loc-sectionDesc">
              End-to-end software development services tailored for Chennai businesses.
            </p>
          </div>
      ...
      <section className="loc-section loc-industriesSection">
        <div className="loc-sectionInner">
          <div className="loc-sectionHeader">
            <h2 className="loc-sectionTitle">
              Industries We Serve in <span className="loc-highlight">Chennai</span>
            </h2>
          </div>
          ...
          <div className="loc-faqList">
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Why choose a software development company in Chennai?</span>
              ...
              <div className="loc-faqAnswer">Chennai offers a strong technology ecosystem and access to skilled engineering talent, making it an ideal hub for software development.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Does mTouch Labs provide custom software development in Chennai?</span>
                <span className="loc-faqChevron">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                </span>
              </summary>
              <div className="loc-faqAnswer">Yes, we provide fully customized software development services tailored to businesses in Chennai.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
                <span className="loc-faqQuestionText">Do you offer mobile app development in Chennai?</span>
                <span className="loc-faqChevron">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                </span>
              </summary>
              <div className="loc-faqAnswer">Yes, we develop iOS, Android, and cross-platform mobile applications for businesses across Chennai.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
              ...
              <div className="loc-faqAnswer">Yes, we offer cloud migration services and AI-powered automation solutions for Chennai-based businesses.</div>
            </details>
            <details className="loc-faqItem">
              <summary className="loc-faqQuestion">
      ...
      <FAQSchema faqs={[
    { q: "Why choose a software development company in Chennai?", a: "Chennai offers a strong technology ecosystem and access to skilled engineering talent, making it an ideal hub for software development." },
    { q: "Does mTouch Labs provide custom software development in Chennai?", a: "Yes, we provide fully customized software development services tailored to businesses in Chennai." },
    { q: "Do you offer mobile app development in Chennai?", a: "Yes, we develop iOS, Android, and cross-platform mobile applications for businesses across Chennai." },
    { q: "Can you help with cloud migration and AI solutions?", a: "Yes, we offer cloud migration services and AI-powered automation solutions for Chennai-based businesses." },
