...
export const metadata: Metadata = {
  ...
  description: "mTouch Labs is a leading software development company in Saudi Arabia delivering custom software, enterprise applications, cloud, and AI solutions.",
  ...
  twitter: {
    ...
    description: "mTouch Labs — software development company serving Saudi Arabia with custom software, cloud, AI and enterprise applications.",
    images: [{ url: "/images/Light.png", alt: "mTouch Labs Software Development Company in Saudi Arabia" }]
  },
...
const localBusinessSchema = {
  ...
  "name": "mTouch Labs — Software Development in Saudi Arabia",
  "url": "https://www.mtouchlabs.com/software-development-company-saudi-arabia",
  "description": "mTouch Labs — custom software, enterprise apps, cloud and AI for clients in Saudi Arabia.",
  "image": "https://www.mtouchlabs.com/images/Light.png",
  "priceRange": "$$",
  "areaServed": { "@type": "Country", "name": "Saudi Arabia" },
  "address": { "@type": "PostalAddress", "addressLocality": "Saudi Arabia", "addressCountry": "SA" },
...
const locationBreadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Software Development Company in Saudi Arabia", "item": "https://www.mtouchlabs.com/software-development-company-saudi-arabia" }
  ]
};
