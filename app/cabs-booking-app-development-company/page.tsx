...
export const metadata: Metadata = {
  title: "Cabs Booking App Development Company |Taxi App Developers | mTouch Labs",
  description: "mTouch Labs is an on-demand mobile app development company that creates user-friendly taxi & auto-booking mobile and web apps to meet your business goals.",
};
			...
			<div className="row justify-content-center">
				<div className="col-lg-8">
					<div className="sec-heading text-center">
						<h2 className="mb15"><span className="ree-text rt40">Top Features of </span> Taxi Booking Mobile App
						</h2>
			...
			<div className="row">
				<div className="col-lg-8">
					...
					<div className="heading-paragrapph mt60">
						<h3 className="mb20 h1">Best Cab Booking App Development</h3>
			...
			<div className="row justify-content-center mt60">
				<div className="col-lg-6">
					<div className="center-btn big-txt">
						<a href="/custom-matrimonial-mobile-app-development" className="ree-btn  ree-btn-grdt2"><i
