...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: "mTouch Labs — software development company serving Kochi with custom software, cloud, AI and enterprise applications.",
    images: [{ url: "/images/Light.png", alt: "mTouch Labs Software Development Company in Kochi" }]
  },
...
const localBusinessSchema = {
  ...
  "name": "mTouch Labs — Software Development in Kochi",
  "url": "https://www.mtouchlabs.com/software-development-company-kochi",
  "description": "mTouch Labs — custom software, enterprise apps, cloud and AI for clients in Kochi.",
  "image": "https://www.mtouchlabs.com/images/Light.png",
  "priceRange": "$$",
  "areaServed": { "@type": "Country", "name": "Kochi" },
...
const locationBreadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Software Development Company in Kochi", "item": "https://www.mtouchlabs.com/software-development-company-kochi" }
  ]
};
